...
## Purpose
Amazing Prime Video is a platform for streaming movies and TV shows. The project's goal is to develop an algorithm to predict which low-budget movies will become popular, beforehand.  The end goal is to purchase streaming rights at a bargain.   
